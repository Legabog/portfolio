...
describe('ProjectsIcon Component', () => {
	test('Test ProjectsIcon renders without errors', () => {
		expect(() => render(<ProjectsIcon />)).not.toThrow();
	});
	...
	test('Test ProjectsIcon renders correct paths attributes', () => {
		...
		expect(pathElementFirst).toHaveAttribute('fill', 'rgb(33, 33, 33)');
		...
		expect(pathElementSecond).toHaveAttribute('fill', 'rgb(33, 33, 33)');
		...
		expect(pathElementThird).toHaveAttribute('fill', 'rgb(33, 33, 33)');
